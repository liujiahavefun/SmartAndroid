...
public class ChromeCircleDrawable extends Drawable implements Drawable.Callback {
    // constants
    ...
    public ChromeCircleDrawable(int[] colors) {
    ...
    public static class Builder {
        ...
        public Drawable build() {
            return new ChromeCircleDrawable(mColors);
        }
    }
}
