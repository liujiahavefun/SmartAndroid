...
#ifndef CLOUDWOOD_ANDROID_NEW_PACKET_H
#define CLOUDWOOD_ANDROID_NEW_PACKET_H
...
{
	p.push_uint16(uint16_t(c.size())); // use uint32 ...
...
{
	for(uint32_t count = p.pop_uint16() ; count >0 ; --count)
	{
...
#endif //CLOUDWOOD_ANDROID_NEW_PACKET_H
